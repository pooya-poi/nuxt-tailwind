<template>
  <div class="bg-white rounded-lg hover:shadow-xl transition transform hover:-translate-y-1 ease-linear duration-100 ">
    <img class="rounded-tl-lg rounded-tr-lg" src="@/assets/img/about.png" alt="" />
