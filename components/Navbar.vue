      ...
      <div class="">
        <div class="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
          <div class="lg:flex lg:items-center">
            ...
            <!-- nav links for larg display  -->
            <div mode="in-out" class="hidden lg:flex nav-links flex flex-col text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
